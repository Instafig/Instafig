...
var glispFuncContexts = []glispFuncContext{
	...
	{"str=",
		2,
		[]string{GLISP_SYMBOL_TYPE_IP, GLISP_SYMBOL_TYPE_LANG, GLISP_SYMBOL_TYPE_DEVICE_ID, GLISP_SYMBOL_TYPE_NETWORK, GLISP_SYMBOL_TYPE_TIMEZONE, GLISP_SYMBOL_TYPE_OS_TYPE},
		false,
		stringFuncCheckFunc,
	},
	{"str!=",
